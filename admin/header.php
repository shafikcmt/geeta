...
<div class="jumbotron-small text-center" style="margin-bottom:0">
  <h1>Online Students Attendance</h1>
</div>
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" href="grade.php">Add Subject</a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a target="_blank" class="nav-link" href="https://teamcse.blogspot.com/">Our Blog</a>
      </li>  
      <li class="nav-item">
